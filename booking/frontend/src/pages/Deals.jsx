...
const dealsData = [
  ...
  {
    id: 2,
    hotelName: "Brezovica Hotel",
    location: "Brezovica, Kosovo",
    price: "$170 / night",
    image: brezovicaImage,
    discount: "15% Off",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    location: "Brezovica, Kosovo",
    price: "$200 / night",
    image: brezovica2Image,
    discount: "15% Off",
  },
  {
    id: 6,
    hotelName: "Liss Villas",
  ...
  {
    id: 7,
    hotelName: "Prishtina City Apartaments",
    location: "Prishtina, Kosovo",
    price: "$55 / night",
    image: prishtina2Image,
    discount: "30% Off",
  },
  {
    id: 8,
    hotelName: "Hotel Platnium",
    location: "Dhermi, Albania",
    price: "$94 / night",
    image: dhermi2Image,
    discount: "15% Off",
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {dealsData.map((deal) => (
            <div
              key={deal.id}
              className="bg-white rounded-2xl shadow-lg overflow-hidden hover:scale-105 transform transition duration-300 relative"
            >
              ...
              <div className="p-4">
                ...
                <button className="mt-4 w-full bg-gray-900 text-white py-2 rounded-lg hover:bg-red-600 hover:scale-105 transition-transform duration-300">
                  More
                </button>
              </div>
            </div>
