...
const destinations = [
  ...
  { name: "Brezovica", image: brezovica0Image },
      ...
      <section className="max-w-8xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {destinations.map((dest) => (
            <div key={dest.name} className="relative rounded-lg overflow-hidden shadow-lg hover:scale-105 transition-transform duration-300">
