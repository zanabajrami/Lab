          ...
          <div className="flex items-center gap-3 ">
            <div className="relative">
              ...
              <input
                ...
                className="pl-11 pr-4 py-3 bg-white border-none shadow-sm rounded-2xl w-full md:w-64 focus:ring-2 focus:ring-indigo-500/20 transition-all outline-none"
              />
            </div>
            ...
            {paginated.map((u) => (
              <div key={u.id} className="p-6 border-b border-slate-50 last:border-none">
                ...
                <div className="flex items-center justify-between bg-slate-50 p-4 rounded-2xl border border-slate-100">
                  ...
                  <span className="text-xs font-medium text-slate-500 truncate max-w-[150px]">{u.email}</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="mt-10 flex items-center justify-between px-4">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex items-center gap-2 px-6 py-2.5 rounded-2xl bg-white shadow-sm hover:shadow-md disabled:opacity-30 transition-all font-black text-slate-600 text-[11px] uppercase tracking-widest border border-transparent hover:border-slate-100"
            >
